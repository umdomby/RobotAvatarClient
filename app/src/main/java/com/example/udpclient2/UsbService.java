...
//                System.out.print("  ");
//                System.out.println(String.valueOf(joy_usb[1]));

//                if (mHandler != null)
//                    mHandler.obtainMessage(MESSAGE_FROM_SERIAL_PORT, data).sendToTarget();

//                items = stringBuilder.toString().split(",");
//                byte[] dataUDP = new byte[10];
                //System.out.println(data);


                if (data.contains(";")) {
//                    byte joy_usb[] = byteArrayOutputStream.toByteArray();

                    EventBus.getDefault().post(new JoyUsbServiceMyService(byteArrayOutputStream.toByteArray()));

                    String str = new String(byteArrayOutputStream.toByteArray(), "UTF-8");
                    stringBuilder.append(str);
                    items = stringBuilder.toString().split(",");
                    EventBus.getDefault().post(new SpeechButtonUsbServiceMyActivity(items[1]));
                    //System.out.println(str);
                    stringBuilder.delete(0, stringBuilder.length());
                    stringBuilder.setLength(0);
//                    if (mHandler != null)
//                        mHandler.obtainMessage(MESSAGE_FROM_SERIAL_PORT, items[1]).sendToTarget();
...
//                    String data2 = new String(joy_usb, "UTF-8");
...
//
////                        if (mHandler != null)
////                            mHandler.obtainMessage(MESSAGE_FROM_SERIAL_PORT, items[i]).sendToTarget();
//
//                    }
//                    System.out.println();
